<?php 
  ...
  if(isset($_POST['submit'])){
    ...
    $sql= "INSERT INTO carpentar (problem, level, urgent) VALUES ('$problem', '$drone', '$urgent')";
      ...
      <form method="POST">
        ...
        <br><br>
            ...
            <br><br>
              ...
              <label for="name">Description of the problem:</label><br>
              <input type="text" class="problem" name="problem" required minlength="0" maxlength="200" size="10"  />
