...
if(isset($_POST['submit'])){
	...
	$flat=$_SESSION['flat_no'];
	$sql="INSERT INTO `kids`(Time_Slot,members,date_book,flat_no) values ('$time','$members','$dob','$flat')";
					...
					<div class="booking-form">
						...
						<form method="POST">
							...
							<div class="row">
								...
								<div class="col-md-3">
									<div class="form-btn">
									<button class="submit-btn" type="submmit" name="submit">Book Slot</button>
									</div>
								</div>
							</div>
						</form>
