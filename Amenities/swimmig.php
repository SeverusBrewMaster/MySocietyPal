...
if(isset($_POST['submit'])){
	...
	$flat=$_SESSION['flat_no'];
	$sql="INSERT INTO `swim`(Time_Slot,members,date_book,flat_no) values ('$time','$members','$dob','$flat')";
...
<head>
	...
	<!-- Custom stlylesheet -->
	<link type="text/css" rel="stylesheet" href="../css/swim.css" />
    <!-- bootstrap core css -->
					...
					<div class="booking-form">
						...
						<form method="POST">
							...
							<div class="row">
								<!-- <div class="col-md-3">
									<div class="form-group">
										<span class="form-label">Amenity</span>
										<select class="form-control">
											<option value="option1">GYM</option>
											<option value="option2">SWIMMING POOL</option>
											<option value="option3">YOGA ROOM</option>
											<option value="option4">GAMES ROOM</option>
											<option value="option5">MULTI PURPOSE HALL</option>
											<option value="option6">AV ROOM</option>
										</select>
										<span class="select-arrow"></span>
									</div>
								</div> -->
								...
								<div class="col-md-3">
									<div class="form-btn">
										<button class="submit-btn" type="submit" name="submit">Book Slot</button>
									</div>
								</div>
							</div>
						</form>
