...
if(isset($_POST['submit'])){
	...
	$flat=$_SESSION['flat_no'];
	$sql="INSERT INTO `AV`(Time_Slot,members,date_book,flat_no) values ('$time','$members','$dob','$flat')";
...
<head>
	...
	<!-- Custom stlylesheet -->
	<link type="text/css" rel="stylesheet" href="../css/av.css" />
    <!-- bootstrap core css -->
					...
					<div class="booking-form">
						...
						<form method="POST">
							...
							<div class="row">
								...
								<div class="col-md-3">
									<div class="form-btn">
										<button class="submit-btn" name ="submit" type="submit">Book Slot</button>
									</div>
								</div>
							</div>
						</form>
